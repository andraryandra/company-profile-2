    ...
    [1], {
        ...
        elyg: function (t, e, r) {
            ...
            var n = r("J4zp"),
                ...
                i = r("lwsE"),
                u = r("W8MJ");
            e.__esModule = !0, e.hasBasePath = w, e.addBasePath = b, e.delBasePath = _, e.isLocalURL = x, e.resolveHref = S, e.markLoadingError = k, e.default = void 0;
            var c = r("X24+"),
                s = r("wkBG"),
                l = g(r("dZ6Y")),
                h = r("g/15"),
            ...
            function S(t, e) {
                ...
                try {
                    var o = new URL(n, r);
                    return o.pathname = (0, c.normalizePathTrailingSlash)(o.pathname), o.origin === r.origin ? o.href.slice(o.origin.length) : o.href
                } catch (a) {
                    return n
                }
            }
            ...
            var L = function () {
                function t(e, r, n, o) {
                    ...
                    i(this, t), this.route = void 0, this.pathname = void 0, this.query = void 0, this.asPath = void 0, this.basePath = void 0, this.components = void 0, this.sdc = {}, this.sub = void 0, this.clc = void 0, this.pageLoader = void 0, this._bps = void 0, this.events = void 0, this._wrapApp = void 0, this.isSsr = void 0, this.isFallback = void 0, this._inFlightRoute = void 0, this._shallow = void 0, this.onPopState = function (t) {
                        ...
                        Component: l,
                        styleSheets: []
                    }, this.events = t.events, this.pageLoader = s, this.pathname = e, this.query = r, this.asPath = (0, f.isDynamicRoute)(e) && __NEXT_DATA__.autoExport ? e : n, this.basePath = "", this.sub = m, this.clc = null, this._wrapApp = d, this.isSsr = !0, this.isFallback = w, "//" !== n.substr(0, 2) && this.changeState("replaceState", (0, h.formatWithValidation)({
                        pathname: e,
                        query: r
                ...
                return u(t, [{
                    ...
                    value: function () {
                        var e = a(o.mark((function e(r, n, a, i) {
                            var u, s, l, g, m, b, S, P, k, R, E, L, O, C, j, I, A, T;
                            return o.wrap((function (e) {
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 3:
                                        if (i._h || (this.isSsr = !1), h.ST && performance.mark("routeChange"), this._inFlightRoute && this.abortComponentLoad(this._inFlightRoute), u = w(a) ? _(a) : a, this._inFlightRoute = a, i._h || !this.onlyAHashChange(u)) {
                                            e.next = 16;
                                            break
                                        }
                                    ...
                                    case 16:
                                        return e.next = 18, this.pageLoader.getPageList();
                                    case 18:
                                        return s = e.sent, e.next = 21, this.pageLoader.promisedBuildManifest;
                                    case 21:
                                        if (l = e.sent, l.__rewrites, g = (0, p.parseRelativeUrl)(n), b = (m = g).pathname, S = m.searchParams, (g = this._resolveHref(g, s)).pathname !== b && (b = g.pathname, n = (0, h.formatWithValidation)(g)), P = (0, d.searchParamsToUrlQuery)(S), b = b ? (0, c.removePathTrailingSlash)(_(b)) : b, this.urlIsNew(u) || (r = "replaceState"), k = (0, c.removePathTrailingSlash)(b), R = i.shallow, E = void 0 !== R && R, L = _(L = a), !(0, f.isDynamicRoute)(k)) {
                                            e.next = 47;
                                            break
                                        }
                                        if (O = (0, p.parseRelativeUrl)(L), C = O.pathname, j = (0, y.getRouteRegex)(k), I = (0, v.getRouteMatcher)(j)(C)) {
                                            e.next = 46;
                                            break
                                        }
                                    ...
                                    case 46:
                                        Object.assign(P, I);
                                    case 47:
                                        return t.events.emit("routeChangeStart", a), e.prev = 48, e.next = 51, this.getRouteInfo(k, b, P, a, E);
                                    case 51:
                                        return A = e.sent, T = A.error, t.events.emit("beforeHistoryChange", a), this.changeState(r, n, a, i), e.next = 58, this.set(k, b, P, u, A).catch((function (t) {
                                    ...
                                    case 66:
                                        if (e.prev = 66, e.t0 = e.catch(48), !e.t0.cancelled) {
                                            e.next = 70;
                                            break
                                        }
                                ...
                                for (;;) switch (t.prev = t.next) {
                                    ...
                                    case 18:
                                        return (l || f) && (p = this.pageLoader.getDataHref((0, h.formatWithValidation)({
                                            pathname: r,
                                            query: n
                                        }), _(a), l)), t.next = 21, this._getData((function () {
                    ...
                    value: function (t, e) {
                        ...
                        return "/404" === n || "/_error" === n || e.includes(n) || e.some((function (e) {
                            if ((0, f.isDynamicRoute)(e) && (0, y.getRouteRegex)(e).re.test(n)) return t.pathname = e, !0
                        })), t
                    }
                }, {
                    key: "prefetch",
                            ...
                            return o.wrap((function (t) {
                                for (;;) switch (t.prev = t.next) {
                                    ...
                                    case 6:
                                        ...
                                        break;
                                    case 11:
                                        return s = (0, c.removePathTrailingSlash)(i), t.next = 14, Promise.all([this.pageLoader.prefetchData(e, r), this.pageLoader[n.priority ? "loadPage" : "prefetch"](s)]);
                                    case 14:
                                    case "end":
                                        return t.stop()
                                }
                    ...
                    value: function (t) {
                        ...
                        return this.sdc[r] ? Promise.resolve(this.sdc[r]) : E(t, this.isSsr).then((function (t) {
                            return e.sdc[r] = t, t
                        }))
                    }
                }, {
        ...
        hS4m: function (t, e, r) {
            ...
            e.__esModule = !0, e.parseRelativeUrl = function (t, e) {
                var r = e ? new URL(e, o) : o,
                    ...
                    l = n.origin,
                    h = n.protocol;
                if (l !== o.origin || "http:" !== h && "https:" !== h) throw new Error("invariant: invalid relative URL");
                return {
                    pathname: a,
                    searchParams: i,
                    search: u,
